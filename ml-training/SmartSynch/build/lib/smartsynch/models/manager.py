...
class ModelManager:
    ...
    def load_base_model(self):
        """Load the base model."""
        # Default to a reasonable number of classes (adjust based on your needs)
        num_classes = 10  # or whatever default number makes sense for your use case
        self.current_model = TaskClassifier(num_classes=num_classes)
        # Initialize an empty category map if needed
        self.category_map = {str(i): i for i in range(num_classes)}
        return self.current_model
